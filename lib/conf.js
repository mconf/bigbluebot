...
if (BIGBLUEBOT_ROOM_ID && BIGBLUEBOT_ATTENDEE_PW && BIGBLUEBOT_MODERATOR_PW) {
  custom.url.meeting.exist = true;
  custom.url.meeting.name = BIGBLUEBOT_ROOM_ID;
  custom.api.password.attendee = BIGBLUEBOT_ATTENDEE_PW;
  custom.api.password.moderator = BIGBLUEBOT_MODERATOR_PW;
}
