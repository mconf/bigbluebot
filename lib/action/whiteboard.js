...
const action = {
  tools: {
    text: {
      description: 'writes textual annotation',
      before: user.present,
      execute: async page => {
    ...
    line: {
      description: 'draws linear annotation',
      before: user.present,
    ...
    ellipse: {
      description: 'draws elliptical annotation',
      before: user.present,
    ...
    triangle: {
      description: 'draws triangular annotation',
      before: user.present,
    ...
    rectangle: {
      description: 'draws rectangular annotation',
      before: user.present,
    ...
    pencil: {
      description: 'draws pencil annotation',
      before: user.present,
      execute: async page => {
  ...
  clear: {
    description: 'clears annotations',
    before: user.present,
  ...
  multi: {
    enable: {
      description: 'enables multi-user whiteboard',
      before: user.present,
    ...
    disable: {
      description: 'disables multi-user whiteboard',
      before: user.present,
